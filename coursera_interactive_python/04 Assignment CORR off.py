...
def draw(canvas):
    ...
    canvas.draw_line([WIDTH - HALF_PAD_WIDTH, paddle2_pos + HALF_PAD_HEIGHT],   
                ...
                PAD_WIDTH, "#b1f2fb")      
    # draw scores
    canvas.draw_text(str(score1), [150,100], 45, "#e3fbb1")
    canvas.draw_text(str(score2), [450,100], 45, "#b1f2fb")        
...
# create frame
frame = simplegui.create_frame("Gabriels Pong", WIDTH, HEIGHT)
frame.set_canvas_background('#23402d')
